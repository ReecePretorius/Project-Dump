...
class TestCase7(unittest.TestCase):
    def test_converter(self):
        ...
        db7 = Database([ \
            Table('Customer', set(['customer_id', 'customer_name', 'store_id']), set(['customer_id']), set([(('store_id',), 'Store', ('store_id',))])), \
            Table('Store', set(['store_id', 'store_name']), set(['store_id']), set())])
...
class TestCase8(unittest.TestCase):
    def test_converter(self):
        ...
        db8 = Database([ \
            Table('Customer', set(['customer_id', 'customer_name']), set(['customer_id']), set()), \
            Table('Store', set(['store_id', 'store_name']), set(['store_id']), set()), \
            Table('Prefers', set(['since', 'customer_id', 'store_id']), set(['since', 'customer_id']), set([(('customer_id',), 'Customer', ('customer_id',)), (('store_id',), 'Store', ('store_id',))]))])
...
class TestCase9(unittest.TestCase):
    def test_converter(self):
        ...
        # print(convert_to_table( erd9 ).tables)
